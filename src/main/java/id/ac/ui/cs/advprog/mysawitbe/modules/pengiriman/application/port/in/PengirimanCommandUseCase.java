...
public interface PengirimanCommandUseCase {
     ...
     */
    PengirimanDTO updateDeliveryStatus(UUID pengirimanId, UUID supirId, String newStatus);

    /**
     * Mandor approves delivery after supir marks it TIBA (triggers payment if fully OK).
     */
